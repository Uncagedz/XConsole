...
function inventoryDetails(vehicle: Vehicle, details: Record<string, unknown>) {
  return Object.fromEntries(Object.entries({
    ...
    mpgCombined: vehicle.mpgCombined,
    estimatedRangeMiles: vehicle.estimatedRangeMiles,
    electricRangeMiles: vehicle.electricRangeMiles,
    fuelTankGallons: vehicle.fuelTankGallons,
    seatingCapacity: vehicle.seatingCapacity,
    thirdRowSeats: vehicle.thirdRowSeats,
    maxTowingCapacity: vehicle.maxTowingCapacity,
    curbWeight: vehicle.curbWeight,
    horsepower: vehicle.horsepower,
    torque: vehicle.torque,
    metadataLoadedAt: vehicle.metadataLoadedAt,
    metadataComplete: vehicle.metadataComplete,
    searchFacts: vehicle.searchFacts,
    msrp: vehicle.msrp,
  ...
  async listVehicles(): Promise<Vehicle[]> {
    ...
    return vehicles.map((vehicle) => {
      ...
      return {
        ...
        bodyStyle: nullableString(details.bodyStyle),
        fuelType: nullableString(details.fuelType),
        powertrainType: nullableString(details.powertrainType),
        mpgCity: nullableNumber(details.mpgCity),
        mpgHighway: nullableNumber(details.mpgHighway),
        mpgCombined: nullableNumber(details.mpgCombined),
        estimatedRangeMiles: nullableNumber(details.estimatedRangeMiles),
        electricRangeMiles: nullableNumber(details.electricRangeMiles),
        fuelTankGallons: nullableNumber(details.fuelTankGallons),
        seatingCapacity: nullableNumber(details.seatingCapacity),
        thirdRowSeats: typeof details.thirdRowSeats === 'boolean' ? details.thirdRowSeats : null,
        maxTowingCapacity: nullableNumber(details.maxTowingCapacity),
        curbWeight: nullableNumber(details.curbWeight),
        horsepower: nullableNumber(details.horsepower),
        torque: nullableNumber(details.torque),
        metadataLoadedAt: nullableString(details.metadataLoadedAt),
        metadataComplete: details.metadataComplete === true,
        searchFacts: jsonStringArray(details.searchFacts ?? []),
        sourceStatuses: [
